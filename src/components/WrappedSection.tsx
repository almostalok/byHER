...
export default function WrappedSection({ onSelectImage }: WrappedProps) {
  ...
  return (
    <section id="community" className="relative w-screen min-w-[100vw] h-full flex-shrink-0 snap-start snap-always bg-[#dfdac3] border-r-2 border-dashed border-[#be3519]/40 flex flex-col justify-center py-6 px-6 sm:px-12 lg:px-16 overflow-y-auto select-none">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="bg-[#f49799] text-[#be3519] border border-[#be3519] font-mono text-[10px] font-bold px-2.5 py-0.5 rounded-full uppercase">
                MIXTAPE 2025
              </span>
            </div>
            ...
            {/* Speech Bubble */}
            <div className="relative bg-[#dfdac3] border-2 border-dashed border-[#be3519] rounded-full px-8 py-3.5 shadow-lg">
            ...
            <p className="font-display text-sm font-bold text-[#522a25] uppercase tracking-wider leading-relaxed">
          ...
          >
            ...
            >
              <img 
                ...
                className="w-full h-auto object-cover transform group-hover:scale-105 transition-transform duration-500 max-h-[380px]"
              />
              ...
              <div className="absolute inset-0 bg-[#522a25]/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                <span className="bg-[#be3519] text-[#ebdcc4] font-display font-bold text-xs uppercase tracking-widest px-6 py-3 rounded-full shadow-lg flex items-center gap-2">
            ...
            <div className="bg-[#0d1b2a] p-5 text-white grid grid-cols-1 sm:grid-cols-2 gap-4 border-t-2 border-[#be3519]">
              
              {/* Stat Card 1 */}
              <div className="bg-[#1b263b] p-4 rounded-2xl border border-[#be3519]/40 space-y-1">
                <p className="font-mono font-bold text-[10px] text-[#f49799] uppercase tracking-widest flex items-center gap-1">
                  <Radio size={12} /> COLLECTIVE BUILD STATS
                </p>
                <p className="font-display font-black text-xl text-[#ebdcc4] uppercase">48+ PROTOTYPES SHIPPED</p>
                <p className="text-xs font-mono text-gray-300">1,500+ Women Upskilled in 0 ➔ 1</p>
              </div>
              ...
              <div className="bg-[#1b263b] p-4 rounded-2xl border border-[#be3519]/40 space-y-1">
                ...
                <p className="font-display font-black text-xl text-[#ebdcc4] uppercase">"Led by Her, Built for All"</p>
                <p className="text-xs font-mono text-gray-300">Genre: Relentless Maker Energy</p>
              </div>
