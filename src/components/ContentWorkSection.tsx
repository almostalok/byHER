...
export default function ContentWorkSection() {
  ...
  return (
    <section id="content-work" className="relative w-screen min-w-[100vw] h-full flex-shrink-0 snap-start snap-always bg-[#dfdac3] border-r-2 border-dashed border-[#be3519]/40 flex flex-col justify-start md:justify-center py-6 px-4 sm:px-8 lg:px-16 overflow-y-auto select-none">
      <div className="max-w-7xl mx-auto w-full space-y-4 sm:space-y-6 my-0 md:my-auto pb-16 md:pb-0">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between border-b-2 border-dashed border-[#be3519] pb-2.5 sm:pb-3 gap-2">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 text-xs sm:text-sm font-bold text-[#522a25] uppercase tracking-widest">
            <span className="font-script text-sm sm:text-lg text-[#be3519] font-bold">Zero to One Pipeline</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-8 items-center">
          ...
          <motion.div 
            ...
            className="lg:col-span-6 relative flex flex-col items-center justify-center min-h-[220px] sm:min-h-[380px]"
          >
            {/* Retro 90s Computer Graphic */}
            <div className="absolute -top-2 -right-1 z-20 w-16 h-12 sm:w-28 sm:h-24 pointer-events-none drop-shadow-lg">
              <img 
            ...
            <div className="relative w-full max-w-md h-44 sm:h-72 rounded-3xl overflow-hidden shadow-2xl border-4 border-[#be3519] bg-[#dfdac3]">
              <img 
            ...
            <div className="absolute -bottom-2 left-4 z-20 w-5 h-5 sm:w-7 sm:h-7 pointer-events-none drop-shadow-md">
              <img 
          ...
          >
            {/* Manifesto Card */}
            <div className="bg-[#ebdcc4] border-3 border-[#be3519] rounded-3xl p-4 sm:p-7 shadow-xl space-y-3 sm:space-y-4">
              <div className="flex items-center justify-between border-b-2 border-dashed border-[#be3519]/40 pb-1.5 sm:pb-2">
                <span className="font-mono text-[10px] sm:text-xs font-bold text-[#be3519] uppercase tracking-widest flex items-center gap-1">
                  <Sparkles size={13} /> 0 ➔ 1 METHODOLOGY
                </span>
                <span className="bg-[#be3519] text-[#ebdcc4] text-[9px] sm:text-[10px] font-display font-black px-2 py-0.5 rounded-full uppercase">
                  PUBLIC SPEC
                </span>
              </div>

              <h3 className="font-display font-black text-lg sm:text-3xl text-[#be3519] uppercase tracking-wide leading-tight">
                FROM CONCEPT TO WORKING SILICON & SERVERS
              </h3>

              <p className="font-display text-[11px] sm:text-sm text-[#522a25] leading-relaxed font-bold uppercase tracking-wider">
              ...
              <div className="pt-2 border-t-2 border-dashed border-[#be3519]/30">
                <button
                  ...
                  className="w-full bg-[#be3519] hover:bg-[#522a25] text-[#ebdcc4] py-2.5 sm:py-3 px-4 sm:px-6 rounded-2xl font-display font-black text-xs sm:text-sm uppercase tracking-widest shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2 cursor-pointer group"
                >
                  <FileText size={16} className="transform group-hover:scale-110 transition-transform" />
        ...
        <div className="bg-[#be3519] text-[#ebdcc4] py-2.5 sm:py-3 px-3 sm:px-8 rounded-2xl border-2 border-[#522a25] shadow-lg">
          <div className="flex flex-wrap items-center justify-between gap-2 text-center sm:text-left">
            <span className="font-display font-black text-[11px] sm:text-sm uppercase tracking-widest text-[#ebdcc4]">
              BUILD PROCESS:
            </span>
            <div className="flex flex-wrap items-center gap-2 sm:gap-6 font-script text-xs sm:text-lg font-bold text-[#ebdcc4]">
